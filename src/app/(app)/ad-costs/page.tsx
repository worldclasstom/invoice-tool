...
function InfluencersIcon({ className, style }: IconProps) {
  return (
    <svg className={className} style={style} viewBox="0 0 24 24" fill="currentColor">
...
function OthersIcon({ className, style }: IconProps) {
  return (
    <svg className={className} style={style} viewBox="0 0 24 24" fill="currentColor">
...
function PlatformIcon({ platform, className, style }: { platform: Platform; className?: string; style?: React.CSSProperties }) {
  switch (platform) {
    case 'facebook': return <FacebookIcon className={className} style={style} />
    case 'tiktok': return <TikTokIcon className={className} style={style} />
    case 'instagram': return <InstagramIcon className={className} style={style} />
    case 'influencers': return <InfluencersIcon className={className} style={style} />
    case 'others': return <OthersIcon className={className} style={style} />
  }
}
